...
public class RendererModel implements Serializable, Cloneable {
    ...
    AbstractGeneratorParameter<Integer> {
        /** {@inheritDoc} */
        public Integer getDefault() {
            return Color.GRAY;
        }
    }
    private IGeneratorParameter<Integer> externalHighlightColor =
    ...
    AbstractGeneratorParameter<Map<IChemObject, Integer>> {
        /** {@inheritDoc} */
        public Map<IChemObject, Integer> getDefault() {
            return new Hashtable<IChemObject, Integer>();
        }
    }
    private IGeneratorParameter<Map<IChemObject, Integer>> colorHash =
        new ColorHash();
    ...
    public void setExternalSelectedPart(IAtomContainer externalSelectedPart) {
        ...
        Map<IChemObject, Integer> colorHash =
